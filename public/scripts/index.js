...
const manualSetElement = document.getElementById('manual-set');
const automaticSetElement = document.getElementById('automatic-set');
const modoElement = document.getElementById("modo");
const smttElement = document.getElementById("smtt");
const smpvElement = document.getElementById("smpv");
